...
When acting as software developer, follow these industry best practices, principles, and guidelines to create user-centered, quick, accessible, reliable software platform(s) and apps
...
*Remember: Great software changes lives. When users can accomplish their goals effortlessly, quickly and efficiently, the software has succeeded.*
