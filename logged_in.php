...
<body>
<p><a name="top"></a> <?php include ("header_logged_in"); ?></p>
...
$('#main_area').html('<table border=0 width=100%><tr><td><h1>Profile</h1></td><td>&nbsp;</td><td valign=top><font color=gray><span title="Visible to all users">Public</span></font></td><td>&nbsp;</td><td valign=top><u id="" class="link" title="Add new entries">Add new entries</u></td><td align=right valign=top><u class="link" title="See how others see my profile">See how others see my profile</u></td></tr></table><table><tr><td valign=top width=48%>Profile ID: "ID" <font color=gray><span title="Only you can see this">Private</span></font><br><br>Profile address: <br><br>"Profile address" https://site_address/ID <font color=gray><span title="Only you can see this">Private</span></font> <br><br>Вася Пупкин <font color=gray><span title="Visible to all users">Public</span></font><br><br>E-Mail: <font color=gray><span title="Visible to all users">Public</span></font><br><br>vasya.pupkin@pupkin.com <u class="link" id="">Delete</u><br><br>Telefon: <font color=gray>Visible only to friends</font><br><br>+ 49 175 4523 6543 <u class="link" id="">Delete</u><br><br>Date of birth: <font color=gray>Visible to all</font><br><br>15 апреля 1990 <u class="link" id="" title="Delete this entry">Delete</u>	<br><br>																	<a name="settings"></a><h2>Settings</h2>Who can add me:<br><br><input type="radio" id="contacted_by_everyone" value="everyone" name="who_can_add_me">Everyone<br><input type="radio" id="contacted_by_only_authorised" value="only_authorised" name="who_can_add_me">Only authorised people<br><input type="radio" id="contacted_by_no_one" value="no_one" name="who_can_add_me">No one<br><br>    Who can contact (message) me:<br><br><input type="radio" id="contacted_by_everyone" value="everyone" name="who_can_contact_me">Everyone<br><input type="radio" id="contacted_by_only_authorised" value="only_authorised" name="who_can_contact_me">Only authorised people<br><input type="radio" id="contacted_by_no_one" value="no_one" name="who_can_contact_me">No one							<br><br> 																			<a name="general_contact_settings"></a>I want to be informed: <br><br><input type="checkbox"> About company news<br> <input type="checkbox"> About cool and new features<h2>General contact settings</h2>How frequently to contact your contacts:<br><br><input type="checkbox" id="notification_weekly" value="weekly">weekly<br><input type="checkbox" id="notification_monthly" value="monthly">monthly<br><input type="checkbox" id="notification_quarterly" value="quarterly">quarterly<br><input type="checkbox" id="notification_halfyearly" value="halfyearly">half-yearly<br><input type="checkbox" id="notification_yearly" value="yearly">yearly<br><br>How to be notified:<br><br><input type="checkbox" id="notification_by_email" value="email">per e-mail<br><input type="checkbox" id="notification_by_sms" value="sms">per sms<br><input type="checkbox" id="notification_onsite" value="onsite">on-site notifications<br><br>Import data | Export data</td><td width=4%>&nbsp;</td><td valign=top width=48%>Notes: <font color=gray><span title="Visible to nobody">Private</span></font><br><br>Text of the note(s)<br><br></td></tr></table>');
});
});
...
Скрипт генерации web_id 

1. Должен проверять наличие id и создавать следующее id с другим порядковым номером
2. Web_id должен быть уникальным
