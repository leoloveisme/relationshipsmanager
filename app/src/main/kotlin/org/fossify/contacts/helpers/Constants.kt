...
// Interaction types
const val INTERACTION_PHONE_CALL = "phone_call"
const val INTERACTION_SMS = "sms"
const val INTERACTION_EMAIL = "email"
const val INTERACTION_IN_PERSON = "in_person"
const val INTERACTION_VIDEO_CALL = "video_call"
const val INTERACTION_SOCIAL_MEDIA = "social_media"
const val INTERACTION_OTHER = "other"
const val INTERACTION_MANUAL = "manual"

enum class UrgencyLevel(val colorResId: Int) {
    GREEN(R.color.urgency_green),
    YELLOW(R.color.urgency_yellow),
    ORANGE(R.color.urgency_orange),
